...
defineToggleSwitch("PITOT_HEAT", 19, 3026, 180, "General", "Pitot Heat Switch, HEAT/OFF")
...
defineRotary("RUDDER_TRIM_KNB", 19, 3031, 165, "General", "Rudder Trim Knob")
...
definePushButton("DEP_0_BTN", 15, 3546, 200, "DEP", "DEP 0 Button")
definePushButton("DEP_1_BTN", 15, 3537, 201, "DEP", "DEP 1 Button")
definePushButton("DEP_2_BTN", 15, 3538, 202, "DEP", "DEP 2 Button")
definePushButton("DEP_3_BTN", 15, 3539, 203, "DEP", "DEP 3 Button")
definePushButton("DEP_4_BTN", 15, 3540, 204, "DEP", "DEP 4 Button")
definePushButton("DEP_5_BTN", 15, 3541, 205, "DEP", "DEP 5 Button")
definePushButton("DEP_6_BTN", 15, 3542, 206, "DEP", "DEP 6 Button")
definePushButton("DEP_7_BTN", 15, 3543, 207, "DEP", "DEP 7 Button")
definePushButton("DEP_8_BTN", 15, 3544, 208, "DEP", "DEP 8 Button")
definePushButton("DEP_9_BTN", 15, 3545, 209, "DEP", "DEP 9 Button")
...
--MFD Right --NOT
definePushButton("MFD_R_ON_DAY", 13, 3501, 434, "MFD Right", "Right MFD On Day")
definePushButton("MFD_R_ON_NGT", 13, 3502, 435, "MFD Right", "Right MFD On Night")
definePushButton("MFD_R_OFF", 13, 3503, 436, "MFD Right", "Right MFD Off")
definePushButton("MFD_R_BRIGHT_INC", 13, 3504, 432, "MFD Right", "Right MFD Brightness Increase")
definePushButton("MFD_R_BRIGHT_DEC", 13, 3505, 433, "MFD Right", "Right MFD Brightness Decrease")
definePushButton("MFD_R_BTN_20", 13, 3525, 59, "MFD Right", "Right MFD Push Button 20")
definePushButton("MFD_R_BTN_19", 13, 3524, 58, "MFD Right", "Right MFD Push Button 19")
definePushButton("MFD_R_BTN_18", 13, 3523, 57, "MFD Right", "Right MFD Push Button 18")
definePushButton("MFD_R_BTN_17", 13, 3522, 56, "MFD Right", "Right MFD Push Button 17")
definePushButton("MFD_R_BTN_16", 13, 3521, 55, "MFD Right", "Right MFD Push Button 16")
definePushButton("MFD_R_BTN_15", 13, 3520, 54, "MFD Right", "Right MFD Push Button 15")
definePushButton("MFD_R_BTN_14", 13, 3519, 53, "MFD Right", "Right MFD Push Button 14")
definePushButton("MFD_R_BTN_13", 13, 3518, 52, "MFD Right", "Right MFD Push Button 13")
definePushButton("MFD_R_BTN_12", 13, 3517, 51, "MFD Right", "Right MFD Push Button 12")
definePushButton("MFD_R_BTN_11", 13, 3516, 50, "MFD Right", "Right MFD Push Button 11")
definePushButton("MFD_R_BTN_10", 13, 3515, 49, "MFD Right", "Right MFD Push Button 10")
definePushButton("MFD_R_BTN_9", 13, 3514, 48, "MFD Right", "Right MFD Push Button 9")
definePushButton("MFD_R_BTN_8", 13, 3513, 47, "MFD Right", "Right MFD Push Button 8")
definePushButton("MFD_R_BTN_7", 13, 3512, 46, "MFD Right", "Right MFD Push Button 7")
definePushButton("MFD_R_BTN_6", 13, 3511, 45, "MFD Right", "Right MFD Push Button 6")
definePushButton("MFD_R_BTN_5", 13, 3510, 44, "MFD Right", "Right MFD Push Button 5")
definePushButton("MFD_R_BTN_4", 13, 3509, 43, "MFD Right", "Right MFD Push Button 4")
definePushButton("MFD_R_BTN_3", 13, 3508, 42, "MFD Right", "Right MFD Push Button 3")
definePushButton("MFD_R_BTN_2", 13, 3507, 41, "MFD Right", "Right MFD Push Button 2")
definePushButton("MFD_R_BTN_1", 13, 3506, 40, "MFD Right", "Right MFD Push Button 1")
