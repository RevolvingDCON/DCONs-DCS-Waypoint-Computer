...
--Electric System
definePushButton("WIPER_ONCE", 38, 3018, 53, "Electric System", "Wiper Once")
defineToggleSwitch("BATTERY", 38, 3001, 264, "Electric System", "Battery")
defineToggleSwitch("ALTERNATOR", 38, 3002, 265, "Electric System", "Alternator")
defineToggleSwitch("GENERATOR", 38, 3003, 268, "Electric System", "Generator")
definePushButton("VOLTMETER_TEST", 38, 3004, 62, "Electric System", "Voltmeter Test")
...
definePushButton("REARM_GENE", 38, 3015, 67, "Electric System", "Gene Rearm")
defineToggleSwitch("CONVOY_TANK", 38, 3016, 63, "Electric System", "Convoy Tank On/Off")
defineToggleSwitch("SAND_FILTER", 38, 3017, 64, "Electric System", "Sand Filter On/Off")

--Intercom Pilot
defineRotary("VHF_AM_RADIO_VOLUME_1", 38, 3221, 68, "Intercom", "VHF AM Radio Volume 1")
defineRotary("FM_RADIO_VOLUME_1", 38, 3222, 70, "Intercom", "FM Radio Volume 1")
defineRotary("UHF_RADIO_VOLUME_1", 38, 3223, 69, "Intercom", "UHF Radio Volume 1")

--Intercom Copilot
defineRotary("VHF_AM_RADIO_VOLUME_2", 38, 3251, 79, "Intercom", "VHF AM Radio Volume 2")
defineRotary("FM_RADIO_VOLUME_2", 38, 3252, 81, "Intercom", "FM Radio Volume 2")
defineRotary("UHF_RADIO_VOLUME_2", 38, 3253, 80, "Intercom", "UHF Radio Volume 2")

--AM Radio
defineTumb("AM_RADIO_SELECTOR", 38, 3141, 128, 0.33, {0, 1}, nil, false, "AM Radio", "AM Radio Selector")
defineRotary("AM_RADIO_FREQUENCY_DIAL_RIGHT", 38, 3142, 129, "AM Radio", "AM Radio Frequency Dial Right")
defineToggleSwitch("AM_FREQUENCY_SELECTOR", 38, 3143, 130, "AM Radio", "AM Radio 25/50kHz Selector")
defineRotary("AM_RADIO_FREQUENCY_DIAL_LEFT", 38, 3144, 131, "AM Radio", "AM Radio Frequency Dial Left")
...
--TV
defineToggleSwitch("TV_ON_OFF", 38, 3081, 124, "TV", "TV On/Off")
definePotentiometer("TV_CONTRAST", 38, 3082, 125, {0, 1}, "TV", "TV Contrast")
definePotentiometer("TV_BRIGHTNESS", 38, 3083, 123, {0, 1}, "TV", "TV Brightness")
defineToggleSwitch("TV_COVER", 38, 3084, 126, "TV", "TV Cover")
...
--PE
defineToggleSwitch("LASING_BUTTON_COVER", 38, 3301, 255, "PE", "Lasing Button Cover")
definePushButton("LASING_BUTTON", 38, 3302, 256, "PE", "Lasing Button")
defineToggleSwitch("MISSILE_LAUNCH_COVER", 38, 3303, 257, "PE", "Missile Launch Cover")
definePushButton("MISSILE_LAUNCH", 38, 3304, 258, "PE", "Missile Launch")
definePushButton("INVERSED_SYMBOLOGY", 38, 3305, 259, "PE", "Inversed Symbology")
definePushButton("INVERSED_IMAGE", 38, 3306, 260, "PE", "Inversed Image")
defineTumb("IMAGE_FOCUS_DOWN", 38, 3307, 261, 1, {-1, 0}, nil, false, "PE", "Image Focus Down")
defineTumb("IMAGE_FOCUS_UP", 38, 3308, 261, 1, {0, 1}, nil, false, "PE", "Image Focus Up")
defineTumb("IMAGE_GAIN_LEFT", 38, 3310, 262, 1, {-1, 0}, nil, false, "PE", "Image Gain Left")
defineTumb("IMAGE_GAIN_RIGHT", 38, 3310, 262, 1, {0, 1}, nil, false, "PE", "Image Gain Right")
defineTumb("IMAGE_BRIGHTNESS_DOWN", 38, 3312, 263, 1, {-1, 0}, nil, false, "PE", "Image Brightness Down")
defineTumb("IMAGE_BRIGHTNESS_UP", 38, 3311, 263, 1, {0, 1}, nil, false, "PE", "Image Brightness Up")
defineTumb("SYMBOLOGY_BRIGHTNESS_LEFT", 38, 3313, 219, 1, {-1, 0}, nil, false, "PE", "Symbology Brightness Left")
defineTumb("SYMBOLOGY_BRIGHTNESS_RIGHT", 38, 3314, 219, 1, {0, 1}, nil, false, "PE", "Symbology Brightness Right")
definePushButton("CAMERA_CENTERING", 38, 3281, 362, "PE", "Camera Centering")
definePushButton("TOGGLE_VDO_VTH", 38, 3282, 364, "PE", "Toggle VDO/VTH")
defineTumb("CAMERA_ZOOM_IN", 38, 3284, 365, 1, {-1, 0}, nil, false, "PE", "Camera Zoom In")
defineTumb("CAMERA_ZOOM_OUT", 38, 3283, 365, 1, {0, 1}, nil, false, "PE", "Camera Zoom Out")
defineTumb("CTH_POWER", 38, 3285, 366, 0.5, {0, 1}, nil, false, "PE", "CTH Power")
defineToggleSwitch("LASER_POWER", 38, 3286, 367, "PE", "Laser Power")
defineTumb("CAMERA_MODE", 38, 3287, 370, 0.25, {0, 1}, nil, false, "PE", "Camera Mode")
...
--Radar Altimeter
defineRotary("RADAR_ALT_BUG", 38, 3339, 93, "Radar Altimeter", "Radar Altimeter Bug Adjust")
defineRotary("RADAR_ALT_POWER", 38, 3340, 91, "Radar Altimeter", "Radar Altimeter Power")
definePushButton("RADAR_ALT_TEST", 38, 3341, 100, "Radar Altimeter", "Radar Altimeter Test")
...
--ADF
defineToggleSwitch("ADF1_ADF2_SELECT", 38, 3101, 166, "ADF", "ADF1/ADF2 Select")
defineToggleSwitch("ADF_TONE_ON_OFF", 38, 3102, 167, "ADF", "ADF Tone On/Off")
defineTumb("ADF_MODE", 38, 3103, 178, 0.33, {0, 1}, nil, false, "ADF", "ADF Mode")
defineRotary("ADF_GAIN", 38, 3104, 179, "ADF", "ADF Gain")
defineRotary("ADF_NAV1_100", 38, 3105, 168, "ADF", "ADF NAV1 100s")
defineRotary("ADF_NAV1_10", 38, 3106, 169, "ADF", "ADF NAV1 10s")
defineRotary("ADF_NAV1_1", 38, 3107, 173, "ADF", "ADF NAV1 1s")
defineRotary("ADF_NAV2_100", 38, 3108, 174, "ADF", "ADF NAV2 100s")
defineRotary("ADF_NAV2_10", 38, 3109, 175, "ADF", "ADF NAV2 10s")
defineRotary("ADF_NAV2_1", 38, 3110, 176, "ADF", "ADF NAV2 1s")
...
--FM Radio
defineTumb("FM_RADIO_MODE", 38, 3191, 272, 0.25, {0, 1}, nil, false, "FM Radio", "FM Radio Mode Select")
defineTumb("FM_RADIO_CHANNEL", 38, 3192, 273, 0.143, {0, 1}, nil, false, "FM Radio", "FM Radio Channel Select")
...
--UHF Radio
defineTumb("UHF_RADIO_MODE", 38, 3161, 383, 0.167, {0, 1}, nil, false, "UHF Radio", "UHF Radio Mode Select")
definePushButton("UHF_RADIO_BUTTON_DRW", 31, 3002, 384, "UHF Radio", "UHF Radio Button DRW")
definePushButton("UHF_RADIO_BUTTON_VLD", 38, 3163, 385, "UHF Radio", "UHF Radio Button VLD")
...
definePushButton("VHF_AM_RADIO_VOL_1_P", 38, 3241, 452, "Intercom", "VHF AM Radio Volume 1 (Push)")
definePushButton("FM_RADIO_VOL_1_P", 38, 3242, 453, "Intercom", "FM Radio Volume 1 (Push)")
definePushButton("UHF_RADIO_VOL_1_P", 38, 3243, 454, "Intercom", "UHF Radio Volume 1 (Push)")
definePushButton("VHF_AM_RADIO_VOL_2_P", 38, 3271, 455, "Intercom", "VHF AM Radio Volume 2 (Push)")
