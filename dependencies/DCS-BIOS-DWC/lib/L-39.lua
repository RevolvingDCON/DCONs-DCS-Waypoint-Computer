...
defineFloat("FRONT_RALT_WARNFLAG", 62, {0, 1}, "Gauges","FRONT Radar Altimeter Warning Flag")
...
defineFloat("FRONT_VARIOMETER_SLIP", 76, {-1, 1},"Gauges","FRONT Variometer Sideslip Indicator")
defineFloat("BACK_VARIOMETER", 416, {-1.0,	-0.875, -0.775,	-0.44,	0.0,	0.44,	0.775,	0.875,	1.0}, "Gauges","BACK Variometer")
defineFloat("BACK_VARIOMETER_TURN", 417, {-1, 1}, "Gauges","BACK Variometer Turn Indicator")
defineFloat("BACK_VARIOMETER_SLIP", 418, {-1, 1},"Gauges","BACK Variometer Sideslip Indicator")
...
defineFloat("FRONT_KPP1273K_DEVBAR_CRS", 35, {-1, 1}, "Gauges","FRONT Artifical Horizont KPP Course Deviation Bar")
defineFloat("FRONT_KPP1273K_DEVBAR_ATL", 34, {-1, 1}, "Gauges","FRONT Artifical Horizont KPP Altitude Deviation Bar")
...
defineFloat("BACK_KPP1273K_DEVBAR_CRS", 372, {-1, 1}, "Gauges","BACK Artifical Horizont KPP Course Deviation Bar")
defineFloat("BACK_KPP1273K_DEVBAR_ATL", 371, {-1, 1}, "Gauges","BACK Artifical Horizont KPP Altitude Deviation Bar")
...
defineFloat("FRONT_HSI_BRG_NEEDLE", 43, {0, 1}, "Gauges","FRONT HSI Bearing Needle")
...
defineFloat("BACK_HSI_BRG_NEEDLE", 380, {0, 1}, "Gauges","BACK HSI Bearing Needle")
...
defineFloat("FRONT_RSBN_BACK_LIGHT", 580, {0, 1}, "Gauges","FRONT RSBN Back Panel Light")
...
defineFloat("BACK_FUEL_QUANT", 427, {0, 1}, "Gauges","BACK Fuel Quantity")
...
defineFloat("FRONT_HELMET_OXY_PRESS", 300, {0, 1}, "Gauges","FRONT Helmet Oxygen Pressure Indicator")

defineFloat("FRONT_BRAKE_HANDLE", 127, {0, 1}, "Gauges","FRONT Brake Handle")
defineFloat("BACK_BRAKE_HANDLE", 542, {0, 1}, "Gauges","BACK Brake Handle")

defineFloat("FRONT_INST_LIGHT_INTENS", 553, {0, 1}, "Gauges","FRONT Instrument Lights Intensity")
defineFloat("FRONT_COMP_LIGHT_INTENS", 558, {0, 1}, "Gauges","FRONT Compass Lights Intensity")
defineFloat("FRONT_EMERG_LIGHT_INTENS", 555, {0, 1}, "Gauges","FRONT Emergency Lights Intensity")
defineFloat("BACK_INST_LIGHT_INTENS", 559, {0, 1}, "Gauges","BACK Instrument Lights Intensity")
defineFloat("BACK_EMERG_LIGHT_INTENS", 560, {0, 1}, "Gauges","BACK Emergency Lights Intensity")
...
definePushButton("PITOT_HEAT_OFF_L", 4, 3069, 292,"Electric System", "Standby (Left) Pitot Tube Heating OFF Button")
definePushButton("PITOT_HEAT_ON_R", 4, 3070, 295,"Electric System", "Main (Right) Pitot Tube Heating ON Button")
...
-- Anti-Icing System
defineTumb("FRONT_ANTI_ICING", 7, 3009, 174, 0.1, {0, 0.2}, nil, false, "AntiICE", "FRONT De-Icing Mode Switch, MANUAL/AUTOMATIC/OFF")
...
defineTumb("FRONT_HELMET_MODE", 7, 3012, 308, 0.5, {0, 1}, nil, false, "Helm Heat", "FRONT Helmet Heating Mode Switch, AUTO/OFF/ON")
...
defineIntegerFromGetter("FRONT_RSBN_CHAN_LAND_DISPLAY", getRSBNLAND, 40, "Readings", "FRONT RSBN LAND Channel Display")
...
defineIntegerFromGetter("FRONT_RADIO_CHN_DISPLAY", getRadioPresetChan_FRONT, 19, "Readings", "FRONT Radio Preset Channel Display")
