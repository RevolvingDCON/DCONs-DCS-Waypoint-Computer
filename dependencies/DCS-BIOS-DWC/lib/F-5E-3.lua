...
defineFloat("FUELQUANTITY_L", 22, {0, 1}, "Gauges", "Fuel Quantity Left")
defineFloat("FUELQUANTITY_R", 23, {0, 1}, "Gauges", "Fuel Quantity Right")
...
defineFloat("EXHAUST_TEMP_R", 14, {0, 1}, "Gauges", "Exhaust Gas Temp Right")
defineFloat("TACHO_L", 16, {0, 1}, "Gauges", "Tachometer Left")
defineFloat("TACHO_PERC_L", 425, {0, 1}, "Gauges", "Tachometer Percent Left")
defineFloat("TACHO_R", 17, {0, 1}, "Gauges", "Tachometer Right")
defineFloat("TACHO_PERC_R", 426, {0, 1}, "Gauges", "Tachometer Percent Right")
defineFloat("UTIL_PRESS", 109, {0, 1}, "Gauges", "Utility Pressure")
defineFloat("FLIGHT_PRESS", 110, {0, 1}, "Gauges", "Flight Pressure")
...
defineFloat("O2QUANTITY", 390, {0, 1}, "Gauges", "O2 Quantity")
defineFloat("O2FLOWINDICATOR", 600, {0, 1}, "Gauges", "O2 Flow Blinker")
...
defineFloat("CABIN_PRESS", 114, {0, 1}, "Gauges", "Cabin Pressure")
...
defineFloat("CHAFF_COUNT_10", 401, {0, 1}, "Gauges", "Chaff Drum Counter 10")
defineFloat("CHAFF_COUNT_1", 402, {0, 1}, "Gauges", "Chaff Drum Counter 1")
defineFloat("FL_COUNT_10", 405, {0, 1}, "Gauges", "Flare Drum Counter 10")
defineFloat("FL_COUNT_1", 406, {0, 1}, "Gauges", "Flare Drum Counter 1")
...
defineFloat("SIGHT_DEP_100", 43, {0, 1}, "Gauges", "Ret Depression Drum 100")
defineFloat("SIGHT_DEP_10", 44, {0, 1}, "Gauges", "Ret Depression Drum 10")
defineFloat("SIGHT_DEP_1", 45, {0, 1}, "Gauges", "Ret Depression Drum 1")
...
defineTumb("IFF4_MASTER", 22, 3011, 209, 0.1, {0, 1}, nil, false,"IFF" , "IFF MODE 1 Code Selector Wheel 1")
defineTumb("IFF4_MASTER", 22, 3012, 210, 0.1, {0, 1}, nil, false,"IFF" , "IFF MODE 1 Code Selector Wheel 2")
defineTumb("IFF4_MASTER", 22, 3013, 211, 0.1, {0, 1}, nil, false,"IFF" , "IFF MODE 3/A Code Selector Wheel 1")
defineTumb("IFF4_MASTER", 22, 3014, 212, 0.1, {0, 1}, nil, false,"IFF" , "IFF MODE 3/A Code Selector Wheel 2")
defineTumb("IFF4_MASTER", 22, 3015, 213, 0.1, {0, 1}, nil, false,"IFF" , "IFF MODE 3/A Code Selector Wheel 3")
defineTumb("IFF4_MASTER", 22, 3016, 214, 0.1, {0, 1}, nil, false,"IFF" , "IFF MODE 3/A Code Selector Wheel 4")
...
-- Instruments --------------------------
defineFloat("AOA_GAUGE", 7, {0, 1}, "Gauges", "AOA Units")
defineFloat("MOTOR_RUN", 85, {1, 0}, "Gauges", "Motor Run Knob")
defineFloat("VARIOMETER", 24, {-1, 1}, "Gauges", "Variometer")
defineFloat("SAI_PITCH", 438, {0, 1}, "Gauges", "SAI Pitch")
defineFloat("SAI_BANK", 439, {0, 1}, "Gauges", "SAI Bank")
defineFloat("SAI_OFF", 440, {0, 1}, "Gauges", "SAI OFF Flag")
defineFloat("SAI_ARROW", 443, {0, 1}, "Gauges", "SAI Knob Arrow")
...
defineFloat("ACCELEROMETER", 6, {0, 1}, "Gauges", "Accelerometer")
defineFloat("ACCELEROMETER_MIN", 902, {0, 1}, "Gauges", "Accelerometer Min")
defineFloat("ACCELEROMETER_MAX", 903, {0, 1}, "Gauges", "Accelerometer Max")

-- AirSpeed/Mach Indicator
defineRotary("IAS_SET", 28, 3001, 180, "AirSpeed Indicator", "Index Setting Pointer Knob")
defineFloat("AIRSPEED", 8, {0, 1}, "Gauges", "Airspeed")
defineFloat("AIRSPEED_MAX", 178, {0, 1}, "Gauges", "Max Airspeed")
defineFloat("AIRSPEED_SET", 177, {0, 1}, "Gauges", "Set Airspeed")
...
defineFloat("ALT_100_P", 10, {0, 1}, "Gauges", "Altimeter 100ft Pointer")
defineFloat("ALT_10000_C", 11, {0, 1}, "Gauges", "Altimeter 10000ft Count")
defineFloat("ALT_1000_C", 520, {0, 1}, "Gauges", "Altimeter 1000ft Count")
defineFloat("ALT_100_C", 521, {0, 1}, "Gauges", "Altimeter 100ft Count")
defineFloat("PRESS_0", 59, {0, 1}, "Gauges", "Pressure Setting 0")
defineFloat("PRESS_1", 58, {0, 1}, "Gauges", "Pressure Setting 1")
defineFloat("PRESS_2", 57, {0, 1}, "Gauges", "Pressure Setting 2")
defineFloat("PRESS_3", 56, {0, 1}, "Gauges", "Pressure Setting 3")
defineFloat("ALT_PNEU_FLAG", 9, {0, 1}, "Gauges", "Altimeter PNEU Flag")
...
defineFloat("AI_PITCH", 81, {-0.5, 0.5}, "Gauges", "Attitude Indicator Pitch")
defineFloat("AI_BANK", 30, {-1, 1}, "Gauges", "Attitude Indicator Bank")
defineFloat("AI_OFF_FLAG", 149, {0, 1}, "Gauges", "Attitude Indicator OFF Flag")
...
defineFloat("HSI_CRS", 35, {0, 1}, "Gauges", "HSI Course Arrow")
defineFloat("HSI_HDG", 144, {0, 1}, "Gauges", "HSI Heading Mark")
defineFloat("HSI_COMP", 32, {0, 1}, "Gauges", "HSI Compass Card")
defineFloat("HSI_BER_POINT", 139, {0, 1}, "Gauges", "HSI Bearing Pointer")
defineFloat("HSI_CRS_DEV", 36, {0, 1}, "Gauges", "HSI Course Dev Indicator")
defineFloat("HSI_Range_100", 268, {0, 1}, "Gauges", "HSI Range 100")
defineFloat("HSI_Range_10", 269, {0, 1}, "Gauges", "HSI Range 10")
defineFloat("HSI_Range_1", 270, {0, 1}, "Gauges", "HSI Range 1")
defineIndicatorLight("HSI_Range_FLAG", 142, "Warning, Caution and IndicatorLights", "HSI Range Flag")
defineFloat("HSI_CRS_10010", 276, {0, 1}, "Gauges", "HSI CourseSel 100 10")
defineFloat("HSI_CRS_1", 277, {0, 1}, "Gauges", "HSI CourseSel 1")
defineFloat("HSI_TO_FROM", 146, {-1, 1}, "Gauges", "HSI To From")
defineFloat("HSI_OFF", 143, {0, 1}, "Gauges", "HSI OFF Flag")
defineFloat("HSI_DEV", 141, {0, 1}, "Gauges", "HSI DevDF Window")
...
defineFloat("CLOCK_CURR_H", 19, {0, 1}, "Gauges", "CLOCK Currtime Hours")
defineFloat("CLOCK_CURR_M", 18, {0, 1}, "Gauges", "CLOCK Currtime Minutes")
defineFloat("CLOCK_ELAP_M", 509, {0, 1}, "Gauges", "CLOCK Elapsed Time Minutes")
defineFloat("CLOCK_ELAP_S", 37, {0, 1}, "Gauges", "CLOCK Elapsed Time Seconds")
...
defineFloat("UHF_PRESET_CHAN", 326, {0, 1}, "Gauges", "UHF Preset Radio Channel")
defineFloat("UHF_100", 302, {0, 1}, "Gauges", "UHF Radio 100MHz")
defineFloat("UHF_10", 303, {0, 1}, "Gauges", "UHF Radio 10MHz")
defineFloat("UHF_1", 304, {0, 1}, "Gauges", "UHF Radio 1MHz")
defineFloat("UHF_01", 305, {0, 1}, "Gauges", "UHF Radio 0.1MHz")
defineFloat("UHF_0025", 306, {0, 1}, "Gauges", "UHF Radio 0.025MHz")
