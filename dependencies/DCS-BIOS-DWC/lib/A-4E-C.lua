...
defineIndicatorLight("APN153-MEMORYLIGHT", 171, "Doppler Nav Lights", "Memory Light (yellow)")
defineFloat("APN153-DRIFT-GAUGE", 172, {-1, 1}, "Doppler Nav", "Drift Gauge")
defineFloat("APN153-SPEED-Xnn", 173, {0, 1}, "Doppler Nav", "Speed Xnn")
defineFloat("APN153-SPEED-nXn", 174, {0, 1}, "Doppler Nav", "Speed nXn")
defineFloat("APN153-SPEED-nnX", 175, {0, 1}, "Doppler Nav", "Speed nnX")
defineFloat("NAV_CURPOS_LAT_Xnnnn", 178, {0, 1}, "Doppler Nav Position", "Current Latitude Xnnnn")
defineFloat("NAV_CURPOS_LAT_nXnnn", 179, {0, 1}, "Doppler Nav Position", "Current Latitude nXnnn")
defineFloat("NAV_CURPOS_LAT_nnXnn", 180, {0, 1}, "Doppler Nav Position", "Current Latitude nnXnn")
defineFloat("NAV_CURPOS_LAT_nnnXn", 181, {0, 1}, "Doppler Nav Position", "Current Latitude nnnXn")
defineFloat("NAV_CURPOS_LAT_nnnnX", 182, {0, 1}, "Doppler Nav Position", "Current Latitude nnnnX")
defineFloat("NAV_CURPOS_LON_Xnnnnn", 184, {0, 1}, "Doppler Nav Position", "Current Longitude Xnnnnn")
defineFloat("NAV_CURPOS_LON_nXnnnn", 185, {0, 1}, "Doppler Nav Position", "Current Longitude nXnnnn")
defineFloat("NAV_CURPOS_LON_nnXnnn", 186, {0, 1}, "Doppler Nav Position", "Current Longitude nnXnnn")
defineFloat("NAV_CURPOS_LON_nnnXnn", 187, {0, 1}, "Doppler Nav Position", "Current Longitude nnnXnn")
defineFloat("NAV_CURPOS_LON_nnnnXn", 188, {0, 1}, "Doppler Nav Position", "Current Longitude nnnnXn")
defineFloat("NAV_CURPOS_LON_nnnnnX", 189, {0, 1}, "Doppler Nav Position", "Current Longitude nnnnnX")

defineFloat("NAV_DEST_LAT_Xnnnn", 191, {0, 1}, "Doppler Nav Destination", "Destination Latitude Xnnnn")
defineFloat("NAV_DEST_LAT_nXnnn", 192, {0, 1}, "Doppler Nav Destination", "Destination Latitude nXnnn")
defineFloat("NAV_DEST_LAT_nnXnn", 193, {0, 1}, "Doppler Nav Destination", "Destination Latitude nnXnn")
defineFloat("NAV_DEST_LAT_nnnXn", 194, {0, 1}, "Doppler Nav Destination", "Destination Latitude nnnXn")
defineFloat("NAV_DEST_LAT_nnnnX", 195, {0, 1}, "Doppler Nav Destination", "Destination Latitude nnnnX")
defineFloat("NAV_DEST_LON_Xnnnnn", 197, {0, 1}, "Doppler Nav Destination", "Destination Longitude Xnnnnn")
defineFloat("NAV_DEST_LON_nXnnnn", 198, {0, 1}, "Doppler Nav Destination", "Destination Longitude nXnnnn")
defineFloat("NAV_DEST_LON_nnXnnn", 199, {0, 1}, "Doppler Nav Destination", "Destination Longitude nnXnnn")
defineFloat("NAV_DEST_LON_nnnXnn", 200, {0, 1}, "Doppler Nav Destination", "Destination Longitude nnnXnn")
defineFloat("NAV_DEST_LON_nnnnXn", 201, {0, 1}, "Doppler Nav Destination", "Destination Longitude nnnnXn")
defineFloat("NAV_DEST_LON_nnnnnX", 202, {0, 1}, "Doppler Nav Destination", "Destination Longitude nnnnnX")

defineFloat("ASN41-WINDSPEED-Xxx", 210, {0, 1}, "Doppler Nav", "Windspeed Xnn")
defineFloat("ASN41-WINDSPEED-xXx", 211, {0, 1}, "Doppler Nav", "Windspeed nXn")
defineFloat("ASN41-WINDSPEED-xxX", 212, {0, 1}, "Doppler Nav", "Windspeed nnX")
defineFloat("ASN41-WINDDIR-Xxx", 214, {0, 1}, "Doppler Nav", "Wind Direction Xnn")
defineFloat("ASN41-WINDDIR-xXx", 215, {0, 1}, "Doppler Nav", "Wind Direction nXn")
defineFloat("ASN41-WINDDIR-xxX", 216, {0, 1}, "Doppler Nav", "Wind Direction nnX")
defineFloat("ASN41-MAGVAR-Xxxxx", 204, {0, 1}, "Doppler Nav", "MagVar Xnnnn")
defineFloat("ASN41-MAGVAR-xXxxx", 205, {0, 1}, "Doppler Nav", "MagVar nXnnn")
defineFloat("ASN41-MAGVAR-xxXxx", 206, {0, 1}, "Doppler Nav", "MagVar nnXnn")
defineFloat("ASN41-MAGVAR-xxxXx", 207, {0, 1}, "Doppler Nav", "MagVar nnnXn")
defineFloat("ASN41-MAGVAR-xxxxX", 208, {0, 1}, "Doppler Nav", "MagVar nnnnX")
...
--Cockpit Lights
defineFloat("LIGHTS-FLOOD-WHITE", 111, {0, 0.75}, "Lights", "White Flood Lights (white)")
defineFloat("LIGHTS-FLOOD-RED", 114, {0, 1}, "Lights", "Red Flood Lights (red)")
defineFloat("LIGHTS-INSTRUMENTS", 117, {0, 1}, "Lights", "Instrument Lights (red)")
defineFloat("LIGHTS-CONSOLE", 119, {0, 1}, "Lights", "Console Lights (red)")
defineFloat("APG53A-GLOW", 115, {0, 1}, "Lights", "Radar Glow Light (green)")
...
defineToggleSwitch("Canopy", 17, 71, 0, "Mechanical Systems", "Canopy")
