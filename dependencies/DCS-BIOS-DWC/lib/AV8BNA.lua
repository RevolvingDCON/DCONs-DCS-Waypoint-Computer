...
--by WarLord (aka BlackLibrary) v2.3
...
defineIndicatorLight("JETT_STATION_1_LIGHT", 406, "ACP Lights","Select Station 1 LIGHT")
defineIndicatorLight("JETT_STATION_2_LIGHT", 408, "ACP Lights","Select Station 2 LIGHT")
defineIndicatorLight("JETT_STATION_3_LIGHT", 410, "ACP Lights","Select Station 3 LIGHT")
defineIndicatorLight("JETT_STATION_4_LIGHT", 412, "ACP Lights","Select Station 4 LIGHT")
defineIndicatorLight("JETT_STATION_5_LIGHT", 414, "ACP Lights","Select Station 5 LIGHT")
defineIndicatorLight("JETT_STATION_6_LIGHT", 416, "ACP Lights","Select Station 6 LIGHT")
defineIndicatorLight("JETT_STATION_7_LIGHT", 418, "ACP Lights","Select Station 7 LIGHT")
...
defineIndicatorLight("LFUEL_LIGHT", 326, "Warning, Caution and IndicatorLights","Left Fuel Lamp (green)")
defineIndicatorLight("RFUEL_LIGHT", 327, "Warning, Caution and IndicatorLights","Right Fuel Lamp (green)")
defineIndicatorLight("15SEK_LIGHT", 328, "Warning, Caution and IndicatorLights","15 Sek Lamp (green)")
defineIndicatorLight("MFS_LIGHT", 329, "Warning, Caution and IndicatorLights","MFS Lamp (green)")
defineIndicatorLight("BINGO_LIGHT", 330, "Warning, Caution and IndicatorLights","Bingo Lamp (green)")
defineIndicatorLight("H2O_LIGHT", 331, "Warning, Caution and IndicatorLights","H2O Lamp (green)")
--MIP RIGHT SIDE
defineIndicatorLight("FIRE_LIGHT", 334, "Warning, Caution and IndicatorLights","Fire Lamp (green)")
defineIndicatorLight("LAW_LIGHT", 335, "Warning, Caution and IndicatorLights","LAW Lamp (green)")
defineIndicatorLight("FLAPS_LIGHT", 336, "Warning, Caution and IndicatorLights","Flaps Lamp (green)")
defineIndicatorLight("LTANK_LIGHT", 337, "Warning, Caution and IndicatorLights","Left Tank Lamp (green)")
defineIndicatorLight("RTANK_LIGHT", 338, "Warning, Caution and IndicatorLights","Right Tank Lamp (green)")
defineIndicatorLight("HHYD_LIGHT", 339, "Warning, Caution and IndicatorLights","HHYD Lamp (green)")
defineIndicatorLight("GEAR_LIGHT", 340, "Warning, Caution and IndicatorLights","Gear Lamp (green)")
defineIndicatorLight("OT_LIGHT", 341, "Warning, Caution and IndicatorLights","OT Lamp (green)")
defineIndicatorLight("JPTL_LIGHT", 342, "Warning, Caution and IndicatorLights","JPTL Lamp (green)")
defineIndicatorLight("EFC_LIGHT", 343, "Warning, Caution and IndicatorLights","EFC Lamp (green)")
defineIndicatorLight("GEN_LIGHT", 344, "Warning, Caution and IndicatorLights","GEN Lamp (green)")
--EYEBROW LIGHTS RIGHT SIGHT
defineIndicatorLight("SAM_LIGHT", 276, "Warning, Caution and IndicatorLights","SAM Lamp (green)")
defineIndicatorLight("CW_LIGHT", 277, "Warning, Caution and IndicatorLights","CW Lamp (green)")
defineIndicatorLight("AI_LIGHT", 278, "Warning, Caution and IndicatorLights","AI Lamp (green)")
defineIndicatorLight("AAA_LIGHT", 279, "Warning, Caution and IndicatorLights","AAA Lamp (green)")
--MIP OUTER LEFT SIDE
defineIndicatorLight("NAV_LIGHT", 283, "Warning, Caution and IndicatorLights","NAV Lamp (green)")
defineIndicatorLight("VSTOL_LIGHT", 285, "Warning, Caution and IndicatorLights","VSTOL Lamp (green)")
defineIndicatorLight("AG_LIGHT", 281, "Warning, Caution and IndicatorLights","A/G Lamp (green)")
defineIndicatorLight("SEL_LIGHT", 451, "Warning, Caution and IndicatorLights","SEL Lamp (green)")
defineIndicatorLight("CMBT_LIGHT", 452, "Warning, Caution and IndicatorLights","CMBT Lamp (green)")
defineIndicatorLight("STO_LIGHT", 453, "Warning, Caution and IndicatorLights","STO Lamp (green)")
--CANOPY FRAME
defineIndicatorLight("LEFT_LIGHT", 750, "Warning, Caution and IndicatorLights","Left Lamp Canopy (green)")
defineIndicatorLight("READY_LIGHT", 751, "Warning, Caution and IndicatorLights","Ready Lamp Canopy (green)")
defineIndicatorLight("RIGHT_LIGHT", 752, "Warning, Caution and IndicatorLights","Right Lamp Canopy (green)")
--GEAR LEVER
defineIndicatorLight("GEAR_LEVER_LIGHT", 446, "Warning, Caution and IndicatorLights","Gear Lever Lamp (red)")
--CAUTION PANEL (from upper left to lower right)
defineIndicatorLight("OXY_WLIGHT", 560, "Warning, Caution and IndicatorLights","OXY Warning Light (green)")
defineIndicatorLight("WSLD_WLIGHT", 561, "Warning, Caution and IndicatorLights","WSLD Warning Light (green)")
defineIndicatorLight("HYD1_WLIGHT", 562, "Warning, Caution and IndicatorLights","HYD 1 Warning Light (green)")
defineIndicatorLight("HYD2_WLIGHT", 563, "Warning, Caution and IndicatorLights","HYD 2 Warning Light (green)")
defineIndicatorLight("LPUMP_WLIGHT", 564, "Warning, Caution and IndicatorLights","Left Pump Warning Light (green)")
defineIndicatorLight("RPUMP_WLIGHT", 565, "Warning, Caution and IndicatorLights","Right Pump Warning Light (green)")
defineIndicatorLight("LTRANS_WLIGHT", 566, "Warning, Caution and IndicatorLights","L TRANS Warning Light (green)")
defineIndicatorLight("RTRANS_WLIGHT", 567, "Warning, Caution and IndicatorLights","R TRANS Warning Light (green)")
defineIndicatorLight("FLAPS1_WLIGHT", 568, "Warning, Caution and IndicatorLights","FLAPS 1 Warning Light (green)")
defineIndicatorLight("FLAPS2_WLIGHT", 569, "Warning, Caution and IndicatorLights","FLAPS 2 Warning Light (green)")
defineIndicatorLight("AUTFLP_WLIGHT", 570, "Warning, Caution and IndicatorLights","AUT FLP Warning Light (green)")
defineIndicatorLight("PROP_WLIGHT", 571, "Warning, Caution and IndicatorLights","PROP Warning Light (green)")
defineIndicatorLight("LIDS_WLIGHT", 572, "Warning, Caution and IndicatorLights","LIDS Warning Light (green)")
defineIndicatorLight("OIL_WLIGHT", 573, "Warning, Caution and IndicatorLights","OIL Warning Light (green)")
defineIndicatorLight("APU_GEN_WLIGHT", 574, "Warning, Caution and IndicatorLights","APU GEN Warning Light (green)")
defineIndicatorLight("LINE_WLIGHT", 575, "Warning, Caution and IndicatorLights","Line -- Warning Light (green)")
defineIndicatorLight("GPS_WLIGHT", 576, "Warning, Caution and IndicatorLights","GPS Warning Light (green)")
defineIndicatorLight("DEP_RES_WLIGHT", 577, "Warning, Caution and IndicatorLights","DEP RES Warning Light (green)")
defineIndicatorLight("DC_WLIGHT", 578, "Warning, Caution and IndicatorLights","DC Warning Light (green)")
defineIndicatorLight("STBY_TR_WLIGHT", 579, "Warning, Caution and IndicatorLights","STBY TR Warning Light (green)")
defineIndicatorLight("CS_COOL_WLIGHT", 580, "Warning, Caution and IndicatorLights","CS COOL Warning Light (green)")
defineIndicatorLight("LOAD_WLIGHT", 581, "Warning, Caution and IndicatorLights","LOAD Warning Light (green)")
defineIndicatorLight("CANOPY_WLIGHT", 582, "Warning, Caution and IndicatorLights","CANOPY Warning Light (green)")
defineIndicatorLight("INS_WLIGHT", 583, "Warning, Caution and IndicatorLights","INS Warning Light (green)")
defineIndicatorLight("SKID_WLIGHT", 584, "Warning, Caution and IndicatorLights","SKID Warning Light (green)")
defineIndicatorLight("EFC_WLIGHT", 585, "Warning, Caution and IndicatorLights","EFC Warning Light (green)")
defineIndicatorLight("NWS_WLIGHT", 586, "Warning, Caution and IndicatorLights","NWS Warning Light (green)")
defineIndicatorLight("AFC_WLIGHT", 587, "Warning, Caution and IndicatorLights","AFC Warning Light (green)")
defineIndicatorLight("C_AUT", 588, "Warning, Caution and IndicatorLights","C AUT Warning Light (green)")
defineIndicatorLight("H2O_SEL", 589, "Warning, Caution and IndicatorLights","H2O SEL Warning Light (green)")
defineIndicatorLight("APU_WLIGHT", 590, "Warning, Caution and IndicatorLights","APU Warning Light (green)")
defineIndicatorLight("PITCH_WLIGHT", 591, "Warning, Caution and IndicatorLights","PITCH Warning Light (green)")
defineIndicatorLight("IFF_WLIGHT", 592, "Warning, Caution and IndicatorLights","IFF Warning Light (green)")
defineIndicatorLight("SPD_BRK_WLIGHT", 593, "Warning, Caution and IndicatorLights","SPD BRK Warning Light (green)")
defineIndicatorLight("DROOP_WLIGHT", 594, "Warning, Caution and IndicatorLights","DROOP Warning Light (green)")
defineIndicatorLight("ROLL_WLIGHT", 595, "Warning, Caution and IndicatorLights","ROLL Warning Light (green)")
defineIndicatorLight("AFT_BAY_WLIGHT", 596, "Warning, Caution and IndicatorLights","AFT BAY Warning Light (green)")
defineIndicatorLight("AV_BIT_WLIGHT", 597, "Warning, Caution and IndicatorLights","AV BIT Warning Light (green)")
defineIndicatorLight("LINE2_WLIGHT", 598, "Warning, Caution and IndicatorLights","2 Line --  Warning Light (green)")
defineIndicatorLight("YAW_WLIGHT", 599, "Warning, Caution and IndicatorLights","YAW Warning Light (green)")
defineIndicatorLight("CW_NOGO_WLIGHT", 600, "Warning, Caution and IndicatorLights","CW NOGO Warning Light (green)")
defineIndicatorLight("P_JAM_WLIGHT", 601, "Warning, Caution and IndicatorLights","P JAM Warning Light (green)")
defineIndicatorLight("JAM_HOT_WLIGHT", 602, "Warning, Caution and IndicatorLights","JAM HOT Warning Light (green)")
defineIndicatorLight("ENG_EXC_WLIGHT", 603, "Warning, Caution and IndicatorLights","ENG EXC Warning Light (green)")
defineIndicatorLight("P_NOGO_WLIGHT", 604, "Warning, Caution and IndicatorLights","P NOGO Warning Light (green)")
defineIndicatorLight("CW_JAM_WLIGHT", 605, "Warning, Caution and IndicatorLights","CW JAM Warning Light (green)")
defineIndicatorLight("REPLY_WLIGHT", 606, "Warning, Caution and IndicatorLights","REPLY Warning Light (green)")
--ENGINE DISPLAY
defineFloat("DUCT1", 253, {0, 1}, "Gauges", "Duct 1. Drum Digit")
defineFloat("DUCT2", 254, {0, 1}, "Gauges", "Duct 2. Drum Digit")
defineFloat("DUCT3", 255, {0, 1}, "Gauges", "Duct 3. Drum Digit")
defineFloat("RPM1", 256, {0, 1}, "Gauges", "RPM 1. Drum Digit")
defineFloat("RPM2", 257, {0, 1}, "Gauges", "RPM 2. Drum Digit")
defineFloat("RPM3", 258, {0, 1}, "Gauges", "RPM 3. Drum Digit")
defineFloat("RPM4", 259, {0, 1}, "Gauges", "RPM 4. Drum Digit")
defineFloat("FF1", 260, {0, 1}, "Gauges", "FF 1. Drum Digit")
defineFloat("FF2", 261, {0, 1}, "Gauges", "FF 2. Drum Digit")
defineFloat("FF3", 262, {0, 1}, "Gauges", "FF 3. Drum Digit")
defineFloat("JPT1", 263, {0, 1}, "Gauges", "JPT 1. Drum Digit")
defineFloat("JPT2", 264, {0, 1}, "Gauges", "JPT 2. Drum Digit")
defineFloat("JPT3", 265, {0, 1}, "Gauges", "JPT 3. Drum Digit")
defineFloat("STAB_ARROW", 266, {-1, 1}, "Gauges", "STAB Arrow up/down Drum Digit")
defineFloat("STAB1", 267, {0, 1}, "Gauges", "STAB 1. Drum Digit")
defineFloat("STAB2", 268, {0, 1}, "Gauges", "STAB 2. Drum Digit")
defineFloat("H2O1", 269, {0, 1}, "Gauges", "H2O 1. Drum Digit")
defineFloat("H2O2", 270, {0, 1}, "Gauges", "H2O 2. Drum Digit")
defineFloat("NOZZLE_POINTER", 271, {0, 1}, "Gauges", "Nozzle Pointer")
defineIndicatorLight("H2O_CONTROL_LIGHT", 177, "Warning, Caution and IndicatorLights","H2O Control Lamp (green)")
--FUEL PANEL DISPLAY
defineFloat("FUEL_FLAG", 365, {0, 1}, "Gauges", "FUEL ON/OFF Flag")
defineFloat("TOT_FUEL1", 366, {0, 1}, "Gauges", "TOT FUEL 1. Drum Digit")
defineFloat("TOT_FUEL2", 367, {0, 1}, "Gauges", "TOT FUEL 2. Drum Digit")
defineFloat("TOT_FUEL3", 368, {0, 1}, "Gauges", "TOT FUEL 3. Drum Digit")
defineFloat("TOT_FUEL4", 369, {0, 1}, "Gauges", "TOT FUEL 4. Drum Digit")
defineFloat("TOT_FUEL5", 370, {0, 1}, "Gauges", "TOT FUEL 5. Drum Digit")
defineFloat("LBS_L1", 371, {0, 1}, "Gauges", "LBS Left 1. Drum Digit")
defineFloat("LBS_L2", 372, {0, 1}, "Gauges", "LBS Left 2. Drum Digit")
defineFloat("LBS_L3", 373, {0, 1}, "Gauges", "LBS Left 3. Drum Digit")
defineFloat("LBS_L4", 374, {0, 1}, "Gauges", "LBS Left 4. Drum Digit")
defineFloat("LBS_R1", 375, {0, 1}, "Gauges", "LBS Right 1. Drum Digit")
defineFloat("LBS_R2", 376, {0, 1}, "Gauges", "LBS Right 2. Drum Digit")
defineFloat("LBS_R3", 377, {0, 1}, "Gauges", "LBS Right 3. Drum Digit")
defineFloat("LBS_R4", 378, {0, 1}, "Gauges", "LBS Right 4. Drum Digit")
defineFloat("BINGO1", 381, {0, 1}, "Gauges", "BINGO 1. Drum Digit")
defineFloat("BINGO2", 382, {0, 1}, "Gauges", "BINGO 2. Drum Digit")
defineFloat("BINGO3", 383, {0, 1}, "Gauges", "BINGO 3. Drum Digit")
defineFloat("BINGO4", 384, {0, 1}, "Gauges", "BINGO 4. Drum Digit")
--UPPER AMARMENT PANEL
defineFloat("MODE_GAUGE", 385, {0, 1}, "Gauges", "MODE Drum Digit")
defineFloat("FUZ1", 386, {0, 1}, "Gauges", "Fuze 1. Drum Digit")
defineFloat("FUZ2", 387, {0, 1}, "Gauges", "Fuze 2. Drum Digit")
defineFloat("INVT1", 392, {0, 1}, "Gauges", "InVT x 10 1. Drum Digit")
defineFloat("INVT2", 393, {0, 1}, "Gauges", "InVT x 10 2. Drum Digit")
defineFloat("INVT3", 394, {0, 1}, "Gauges", "InVT x 10 3. Drum Digit")
defineFloat("MULT_GAUGE", 391, {0, 1}, "Gauges", "Multiplicator Drum Digit")
defineFloat("QTY1", 389, {0, 1}, "Gauges", "Quantity 1. Drum Digit")
defineFloat("QTY2", 390, {0, 1}, "Gauges", "Quantity 2. Drum Digit")
--LOWER AMARMENT PANEL
defineFloat("SET_FLAG1", 406, {0, 1}, "Gauges", "SET FLAG 1 Gauge")
defineFloat("SET_FLAG2", 408, {0, 1}, "Gauges", "SET FLAG 2 Gauge")
defineFloat("SET_FLAG3", 410, {0, 1}, "Gauges", "SET FLAG 3 Gauge")
defineFloat("SET_FLAG4", 412, {0, 1}, "Gauges", "SET FLAG 4 Gauge")
defineFloat("SET_FLAG5", 414, {0, 1}, "Gauges", "SET FLAG 5 Gauge")
defineFloat("SET_FLAG6", 416, {0, 1}, "Gauges", "SET FLAG 6 Gauge")
defineFloat("SET_FLAG7", 418, {0, 1}, "Gauges", "SET FLAG 7 Gauge")
--GEAR PANEL DISPLAY --STATUS LIGHTS--
defineIndicatorLight("NOSE_GEAR_Y", 462, "Gear/Flaps Control Panel Lights","Nose Gear Transition Light (yellow)")
defineIndicatorLight("NOSE_GEAR_G", 463, "Gear/Flaps Control Panel Lights","Nose Gear Down Light (green)")
defineIndicatorLight("LEFT_GEAR_Y", 464, "Gear/Flaps Control Panel Lights","Left Gear Transition Light (yellow)")
defineIndicatorLight("LEFT_GEAR_G", 465, "Gear/Flaps Control Panel Lights","Left Gear Down Light (green)")
defineIndicatorLight("RIGHT_GEAR_Y", 466, "Gear/Flaps Control Panel Lights","Right Gear Transition Light (yellow)")
defineIndicatorLight("RIGHT_GEAR_G", 467, "Gear/Flaps Control Panel Lights","Right Gear Down Light (green)")
defineIndicatorLight("MAIN_GEAR_Y", 469, "Gear/Flaps Control Panel Lights","Main Gear Transition Light (yellow)")
defineIndicatorLight("MAIN_GEAR_G", 468, "Gear/Flaps Control Panel Lights","Main Gear Down Light (green)")
--BRAKE/ HYD DISPLAY
defineFloat("BRAKE1", 550, {0, 1}, "Gauges", "Brake 1. Drum Digit")
defineFloat("BRAKE2", 551, {0, 1}, "Gauges", "Brake 2. Drum Digit")
defineFloat("BRAKE3", 552, {0, 1}, "Gauges", "Brake 3. Drum Digit")
defineFloat("HYD11", 553, {0, 1}, "Gauges", "Hydraulic 1 1. Drum Digit")
defineFloat("HYD12", 554, {0, 1}, "Gauges", "Hydraulic 1 2. Drum Digit")
defineFloat("HYD13", 555, {0, 1}, "Gauges", "Hydraulic 1 3. Drum Digit")
defineFloat("HYD21", 556, {0, 1}, "Gauges", "Hydraulic 2 1. Drum Digit")
defineFloat("HYD22", 557, {0, 1}, "Gauges", "Hydraulic 2 2. Drum Digit")
defineFloat("HYD23", 558, {0, 1}, "Gauges", "Hydraulic 2 3. Drum Digit")
--FLAP POSITION DISPLAY
defineFloat("FLAP_POS1", 455, {0, 1}, "Gauges", "Flap Position 1. Drum Digit")
defineFloat("FLAP_POS2", 456, {0, 1}, "Gauges", "Flap Position 2. Drum Digit")
...
end, 1, "External Aircraft Model", "Position Lights (green,red,white)")
defineIntegerFromGetter("EXT_FORMATION_LIGHTS", function()
	return math.floor(LoGetAircraftDrawArgumentValue(201)*65535)
end, 65535, "External Aircraft Model", "Formation Lights (green)")
